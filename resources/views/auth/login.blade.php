...
<body class="bg-gradient-to-r from-red-100 to-orange-100 h-screen">
  <div class="container">
    <div class="flex justify-center items-center h-screen">
      <div class="w-9/12 flex flex-wrap justify-end items-center border border-gray-200 rounded-md shadow-sm" style="background: rgba(255, 255, 255, 0.69)">
        <div class="w-1/2">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" xml:space="preserve" data-imageid="rocket-boy-26" imageName="Rocket Boy" class="illustrations_image w-full">
          <style type="text/css">
          ...
          <g id="Character_rocket-boy-26">
            <path class="st3_rocket-boy-26 targetColor" d="M307.4,142.8c0,0-10.6,48.1-10.2,68c0,1,3.1,3.4,3.2,4.3c1.5,17.8-55.8,2.8-55.8,2.8s-2.1-37.7,2.1-51.2&#xA;&#9;&#9;s8.8-16.4,8.8-16.4s38.3-15.1,45.1-12.9S307.4,142.8,307.4,142.8z" style="fill: rgb(253, 104, 104);"/>
            <polygon class="st3_rocket-boy-26 targetColor" points="286.8,163.3 359.7,125.1 353.9,106.3 275.9,145.9 &#9;" style="fill: rgb(253, 104, 104);"/>
            ...
            <path class="st0_rocket-boy-26" d="M269.1,135.8h-0.2c-2-0.1-3.8-2-4.5-3.2c-1.5-2.6-1.6-5.4-0.1-7.4c0.4-0.6,0.9-1,1.6-1.3&#xA;&#9;&#9;c2.3-1,4.1,1.3,5.2,2.7l0.3,0.3c0.2,0.3,0.2,0.7-0.1,0.9s-0.7,0.2-0.9-0.1l-0.3-0.3c-1.2-1.6-2.5-2.9-3.7-2.3&#xA;&#9;&#9;c-0.4,0.2-0.8,0.5-1.1,0.9c-1.2,1.6-1.1,3.8,0.1,6c0.7,1.2,2.2,2.5,3.5,2.6c0.6,0,1.1-0.3,1.5-0.7c0.2-0.3,0.6-0.3,0.9-0.1&#xA;&#9;&#9;c0.3,0.2,0.3,0.6,0.1,0.9c0,0,0,0,0,0C270.9,135.3,270.1,135.8,269.1,135.8z"/>
              ...
              <ellipse transform="matrix(0.9944 -0.1057 0.1057 0.9944 -11.2339 30.0201)" class="st1_rocket-boy-26" cx="277.5" cy="120.9" rx="4.3" ry="3.3"/>
            <path class="st0_rocket-boy-26" d="M277.2,124.9c-2.4,0-4.5-1.4-4.7-3.4c-0.2-2.2,1.8-4.1,4.5-4.4c1.2-0.2,2.5,0.1,3.5,0.7c1,0.6,1.7,1.5,1.8,2.7&#xA;&#9;&#9;c0.2,2.2-1.8,4.1-4.5,4.4C277.7,124.9,277.5,124.9,277.2,124.9z M277.7,118.3c-0.2,0-0.4,0-0.5,0c-2,0.2-3.5,1.6-3.4,3&#xA;&#9;&#9;s1.9,2.5,3.9,2.2s3.5-1.6,3.4-3l0,0c-0.1-0.7-0.6-1.4-1.2-1.7C279.3,118.4,278.5,118.2,277.7,118.3z"/>
              ...
              <ellipse transform="matrix(0.9944 -0.1057 0.1057 0.9944 -11.1408 30.9458)" class="st1_rocket-boy-26" cx="286.3" cy="120.5" rx="4.3" ry="3.3"/>
        ...
        <div class="w-md border-l-2 border-gray-100">
          <div class="p-10">
            <h1 class="text-center text-2xl font-extrabold my-3 tracking-wides border-b border-gray-300 p-2">SVTB CRISBAR</h1>
            <div class="my-5">
            ...
            <form action="{{ route('auth.login_process') }}" method="post" id="myForm">
              ...
              <div class="mb-4">
                ...
                <input type="text" name="username" id="username" class="border border-gray-500 text-gray-900 text-sm rounded-lg focus:outline-none block w-full p-2.5" autocomplete="off">
              </div>
              <div class="mb-4">
